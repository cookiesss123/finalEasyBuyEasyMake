<template>
    <!-- ref 都要叫modal -->
    <div class="loadingModal modal fade bg-transparent" ref="modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
...
export default {
  ...
  mounted () {
    this.myModal = new Modal(this.$refs.modal, {
      keyboard: false // 不能用 esc關閉
      // backdrop: false // 不能用滑鼠點掉旁邊關閉 但會沒遮罩
    })
    // console.log(this.myModal, '我的modal')
  }
