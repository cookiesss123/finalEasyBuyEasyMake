<template>
    <main class="py-64 bg-img-fixed loginSignupBg d-flex">
                  ...
                  <div class="col-md-6">
                    <div class="card border border-2 border-white bg-transGray-4 rounded-20">
                        <div class="card-header row bg-white rounded-top-15 p-0 m-0 text-center border-0 position-relative">
                            <h3 class="header-active fw-bold py-3 col-6 bg-primary text-white position-absolute fs-4" :class="{'start-0': activePage === '登入', 'rounded-topLeft-20':  activePage === '登入', 'start-50': activePage === '註冊','rounded-topRight-20':  activePage === '註冊'}">
                          {{ activePage }}
                          </h3>
