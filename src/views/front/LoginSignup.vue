<template>
  ...
  <!-- background-size: cover; 都可以吧?? 現在透明就不會擋到了 -->
            ...
            <div class="container">
              <ul class="list-unstyled d-flex mt-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="card border border-2 border-white bg-transGray-4 rounded-20">
                          <div class="card-header row bg-white rounded-top-5 p-0 m-0 text-center border-0 position-relative">
                              <h3 class="header-active py-3 col-6 bg-primary text-white position-absolute fs-4" :class="{'start-0': activePage === '登入', 'rounded-topLeft-5':  activePage === '登入', 'start-50': activePage === '註冊','rounded-topRight-5':  activePage === '註冊'}">
                            {{ activePage }}
                            </h3>

                            <div class="col-6 m-0 px-0 bg-transparent" style="border-radius: 20px 0 0 0;">
                              <h3 class="mb-0 fs-4 fw-bold">
                                <a href="#" @click.prevent="activePage = '登入'" class="blueBottomLine py-3 d-inline-block w-100 text-decoration-none fw-bold" >登入</a>
                              </h3>
                            </div>
                            <div class="col-6  m-0 px-0 bg-transparent"  style="border-radius:0 20px 0 0;">
                              <h3 class="mb-0 fs-4 fw-bold">
                                <a href="#" @click.prevent="activePage = '註冊'" class="blueBottomLine py-3 d-inline-block w-100 text-decoration-none fw-bold" >註冊</a>
                              </h3>
                            </div>
                          </div>
                          <div class="card-body mt-3">
                            ...
                            <div class="d-flex align-items-center justify-content-center">
                              <img src="../../assets/images/loadingLogo.png" class="logo me-1 mt-n2" style="height: 60px;" alt="甜點食譜一鍵購logo">
                              <div>
